...
const show = () => {
    ...
    const [brand, fetchBrand] = useState();
    ...
    const deleteBrand = (id) => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                setLoader(true) 
                    const res =  fetch(`${apiUrl}/admin/brand/${id}`, {
                        method: 'DELETE',
                        headers: {
                            'Content-type': 'application/json',
                            'Accept': 'application/json',
            ...
            <div className='container'>
                <div className='row py-5'>
                    <div className='d-flex justify-content-between mt-5 pb-3'>
                        ...
                        <Link to="/admin/brand/create"><button className='btn btn-primary'>Create</button></Link>
                    </div>

...
const CheckOut = () => {
    ...
    const {  cartData,shippingCharge, subTotal,grandTotal,shippingLoader } =useContext(CartContext)
                        ...
                        <div className='row'>
                            ...
                            <div className='col-md-5'>
                                ...
                                <div className='row '>
                                    <div className='col-md-12'>
                                        ...
                                        <div className='d-flex justify-content-between border-bottom  py-2'>
                                            ...
                                            <div className='text-end'>{shippingLoader ? (
                                ...
                                <div className='d-flex py-3'>
                                    <button className={`btn btn-primary ${shippingLoader ?'disabled':""}`}>Pay Now</button>
                                </div>
                            </div>
                        </div>
                    </form>
